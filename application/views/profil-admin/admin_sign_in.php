    <div class="self-center lg:w-1/3  pt-12 pb-10 px-4 sm:px-6 lg:px-8 md:pt-24">
            ...
            <div class="mt-5">
                ...
                <form id="form">
                    <div class="grid gap-y-4">
                        <!-- Form Group -->
                        <div class="mb-2">
                            <label for="identifiant" class="block text-primary-50 text-sm mb-2">Identifiant:</label>
                            <input type="text" id="identifiant" name="identifiant" value="admin" class="py-3 px-4 block w-full rounded-lg text-sm focus:border-primary focus:ring-primary disabled:opacity-50 disabled:pointer-events-none field" required aria-describedby="numero-voiture-error">
                        </div>
                        <!-- End Form Group -->

                        <!-- Form Group -->
                        <div class="mb-2">
                            <label for="mdp" class="block text-sm mb-2 text-primary-50">Mot de passe</label>
                            <input type="password" id="mdp" name="mdp"  value="admin" class="py-3 px-4 block w-full rounded-lg text-sm focus:border-primary focus:ring-primary disabled:opacity-50 disabled:pointer-events-none field" required aria-describedby="numero-voiture-error">
                        </div>
                        <!-- End Form Group -->
...
<script src="<?php echo base_url("assets/js/loginAdmin.js")?>" type="module"></script>
