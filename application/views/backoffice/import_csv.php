<div class="flex flex-col lg:flex-row mx-2 justify-evenly">
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-0">
      <div class="max-w-xl mx-auto">
        ...
        <div class="mt-12">
          <!-- Form -->
          <form id="dateForm" method="post" action="readCsv" enctype="multipart/form-data">

            <div class="mb-2">
                <label for="separator" class="block text-sm mb-2 text-primary-50">Separateur</label>
                <select id="separator" name="separator" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none field" required aria-describedby="type-error">
                    <option value=",">Virgule ","</option>
                    <option value=";">Point virgule ";"</option>
                </select>
            </div>
            <div>
                <label for="hs-work-email-hire-us-2" class="block mb-2 text-sm text-primary-50 font-medium">Service</label>
                <input type="file" name="file" id="file" autocomplete="file" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
            </div>

            <div>
                <label for="hs-work-email-hire-us-2" class="block mb-2 text-sm text-primary-50 font-medium">Travaux</label>
                <input type="file" name="travaux" id="travaux" autocomplete="file" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
            </div>
