          ...
          <form>
            <div class="grid gap-4 lg:gap-6">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                <div>
                  <label for="hs-firstname-hire-us-2" class="block mb-2 text-sm text-primary-50 font-medium">First Name</label>
                ...
                <div>
                  <label for="hs-lastname-hire-us-2" class="block mb-2 text-sm text-primary-50 font-medium">Last Name</label>
              ...
              <div>
                <label for="hs-work-email-hire-us-2" class="block mb-2 text-sm text-primary-50 font-medium">Work Email</label>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                <div>
                  <label for="hs-company-hire-us-2" class="block mb-2 text-sm text-primary-50 font-medium">Company</label>
                ...
                <div>
                  <label for="hs-company-website-hire-us-2" class="block mb-2 text-sm text-primary-50 font-medium">Company Website</label>
              ...
              <div>
                <label for="hs-about-hire-us-2" class="block mb-2 text-sm text-primary-50 font-medium">Details</label>
            ...
            <div class="mt-6 grid">
              <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-primary-500 text-white hover:bg-primary-700 disabled:opacity-50 disabled:pointer-events-none">Send inquiry</button>
            </div>
            ...
            <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200">
              ...
              <!-- <div>
                <div class="inline-flex gap-x-2">
                  ...
                  <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-primary-500 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="#">
              ...
              <div id="hs-as-table-collapse" class="hs-collapse hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-basic-collapse">
                <div class="pb-4 px-6">
                  <div class="flex items-center space-x-2">
                    ...
                    <!-- <span class="size-5 flex justify-center items-center rounded-full bg-primary-500 text-white">
                  ...
                  <td class="size-px whitespace-nowrap">
                    <button type="button" class="block" data-hs-overlay="#hs-ai-invoice-modal">
                      <span class="block px-6 py-2">
                        <span class="font-mono text-sm text-primary-500">#ADUQ2189H1-0038</span>
                      </span>
                    </button>
                  </td>
                  <td class="size-px whitespace-nowrap">
